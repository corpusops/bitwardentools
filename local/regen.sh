...
vv cookiecutter --no-input -o "$out" -f "$u" \
    name="vaultier2bitwarden" \
    git_ns="corpusops" \
    lname="vaultier2bitwarden" \
    eggname="vaultier2bitwarden" \
    infra_domain="example.com" \
    simple_docker_image="corpusops/vaultier2bitwarden" \
    py_ver="3.8" \
    with_node="y" \
    node_version="lts/*" \
    git_server="github.com" \
    git_project_server="github.com" \
    git_project="vaultier2bitwarden" \
    git_scheme="https" \
    git_user="" \
    git_project_url="https://github.com/corpusops/vaultier2bitwarden" \
    out_dir="." \
    docker_registry="" \
    app_type="simplecompose" \
    ck_type="simplecompose" \
    docker_image="corpusops/vaultier2bitwarden" \
